...
D2D1_3DPERSPECTIVETRANSFORM_INTERPOLATION_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_3DPERSPECTIVETRANSFORM_PROP :: enum {
	INTERPOLATION_MODE = 0,
	BORDER_MODE = 1,
	DEPTH = 2,
...
D2D1_3DTRANSFORM_INTERPOLATION_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_COLORMANAGEMENT_ALPHA_MODE :: enum {
	PREMULTIPLIED = 1,
	STRAIGHT = 2,
}

D2D1_COLORMANAGEMENT_PROP :: enum {
...
D2D1_COLORMANAGEMENT_QUALITY :: enum {
	PROOF = 0,
	NORMAL = 1,
	BEST = 2,
}

D2D1_COLORMANAGEMENT_RENDERING_INTENT :: enum {
	PERCEPTUAL = 0,
...
D2D1_CONVOLVEMATRIX_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_DIRECTIONALBLUR_OPTIMIZATION :: enum {
	SPEED = 0,
	BALANCED = 1,
	QUALITY = 2,
}
...
D2D1_DISTANTDIFFUSE_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_DISTANTSPECULAR_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_DPICOMPENSATION_INTERPOLATION_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_DPICOMPENSATION_PROP :: enum {
	INTERPOLATION_MODE = 0,
	BORDER_MODE = 1,
	INPUT_DPI = 2,
}
...
D2D1_GAUSSIANBLUR_OPTIMIZATION :: enum {
	SPEED = 0,
	BALANCED = 1,
	QUALITY = 2,
}
...
D2D1_HDRTONEMAP_DISPLAY_MODE :: enum {
	SDR = 0,
	HDR = 1,
}

D2D1_HDRTONEMAP_PROP :: enum {
...
D2D1_INTERPOLATION_MODE_DEFINITION :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_OPACITYMETADATA_PROP :: enum {
	INPUT_OPAQUE_RECT = 0,
}
...
D2D1_POINTDIFFUSE_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_POINTSPECULAR_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_SCALE_INTERPOLATION_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_SPOTDIFFUSE_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_SPOTSPECULAR_SCALE_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
...
D2D1_SVG_ASPECT_SCALING :: enum {
	MEET = 0,
	SLICE = 1,
}

D2D1_SVG_ATTRIBUTE_POD_TYPE :: enum {
	FLOAT = 0,
	COLOR = 1,
	FILL_MODE = 2,
	DISPLAY = 3,
...
D2D1_SVG_ATTRIBUTE_STRING_TYPE :: enum {
	SVG = 0,
	ID = 1,
}

D2D1_SVG_DISPLAY :: enum {
	INLINE = 0,
	NONE = 1,
}

D2D1_SVG_LENGTH_UNITS :: enum {
	NUMBER = 0,
	PERCENTAGE = 1,
}

D2D1_SVG_LINE_CAP :: enum {
	BUTT = 0,
	SQUARE = 1,
	ROUND = 2,
}

D2D1_SVG_LINE_JOIN :: enum {
	BEVEL = 1,
	MITER = 3,
	ROUND = 2,
}

D2D1_SVG_OVERFLOW :: enum {
	VISIBLE = 0,
	HIDDEN = 1,
}

D2D1_SVG_PAINT_TYPE :: enum {
	NONE = 0,
	COLOR = 1,
	CURRENT_COLOR = 2,
	URI = 3,
...
D2D1_SVG_UNIT_TYPE :: enum {
	USER_SPACE_ON_USE = 0,
	OBJECT_BOUNDING_BOX = 1,
}

D2D1_SVG_VISIBILITY :: enum {
	VISIBLE = 0,
	HIDDEN = 1,
}
...
D2D1_YCBCR_CHROMA_SUBSAMPLING :: enum {
	AUTO = 0,
	_420 = 1,
	_422 = 2,
	_444 = 3,
...
D2D1_YCBCR_INTERPOLATION_MODE :: enum {
	NEAREST_NEIGHBOR = 0,
	LINEAR = 1,
	CUBIC = 2,
	MULTI_SAMPLE_LINEAR = 3,
